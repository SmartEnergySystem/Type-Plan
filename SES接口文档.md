...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|usernameEditDTO|usernameEditDTO|body|true|UsernameEditDTO|UsernameEditDTO|
|&emsp;&emsp;newUsername|||false|string||
...
|&emsp;&emsp;endTime|结束时间，格式：HH:mm:ss||false|LocalTimeReq|LocalTimeReq|
|&emsp;&emsp;&emsp;&emsp;hour|||false|string||
|&emsp;&emsp;&emsp;&emsp;minute|||false|string||
|&emsp;&emsp;&emsp;&emsp;nano|||false|integer||
|&emsp;&emsp;&emsp;&emsp;second|||false|string||
|&emsp;&emsp;modeId|模式ID||false|integer(int64)||
|&emsp;&emsp;policyId|策略ID||false|integer(int64)||
|&emsp;&emsp;startTime|开始时间，格式：HH:mm:ss||false|LocalTimeReq|LocalTimeReq|
|&emsp;&emsp;&emsp;&emsp;hour|||false|string||
|&emsp;&emsp;&emsp;&emsp;minute|||false|string||
|&emsp;&emsp;&emsp;&emsp;nano|||false|integer||
|&emsp;&emsp;&emsp;&emsp;second|||false|string||
...
|&emsp;&emsp;endTime||LocalTimeRes|LocalTimeRes|
...
|&emsp;&emsp;modeId||integer(int64)||
|&emsp;&emsp;policyId||integer(int64)||
|&emsp;&emsp;startTime||LocalTimeRes|LocalTimeRes|
|&emsp;&emsp;&emsp;&emsp;hour||integer||
|&emsp;&emsp;&emsp;&emsp;minute||integer||
|&emsp;&emsp;&emsp;&emsp;nano||integer||
|&emsp;&emsp;&emsp;&emsp;second||integer||
...
|&emsp;&emsp;id|策略ID|integer(int64)||
|&emsp;&emsp;itemCount|策略条目数量|integer(int32)||
|&emsp;&emsp;name|策略名称|string||
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|idList|要查询的设备id列表|query|false|array|integer|
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|Result«List«DeviceDataVO»»|
|401|Unauthorized||
|403|Forbidden||
|404|Not Found||
...
| -------- | -------- | ----- |----- | 
|code||integer(int32)|integer(int32)|
|data||array|DeviceDataVO|
|&emsp;&emsp;deviceId||integer(int64)||
|&emsp;&emsp;isRealTime||integer(int32)||
|&emsp;&emsp;lastUpdatedTime||string(date-time)||
|&emsp;&emsp;modeName||string||
|&emsp;&emsp;policyName||string||
|&emsp;&emsp;power||number(float)||
|&emsp;&emsp;status||integer(int32)||
|message||string||
...
**接口地址**:`/api/device/{id}/alertReport`
...
| -------- | -------- | ----- | -------- | -------- | ------ |
|id|id|path|true|integer(int64)||
|reportQueryDTO|reportQueryDTO|body|true|ReportQueryDTO|ReportQueryDTO|
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|Result«AlertReportResultDTO»|
|201|Created||
|401|Unauthorized||
|403|Forbidden||
|404|Not Found||
...
| -------- | -------- | ----- |----- | 
|code||integer(int32)|integer(int32)|
|data||AlertReportResultDTO|AlertReportResultDTO|
|&emsp;&emsp;alertReports||array|AlertReportVO|
|&emsp;&emsp;&emsp;&emsp;level||integer||
|&emsp;&emsp;&emsp;&emsp;message||string||
|&emsp;&emsp;&emsp;&emsp;modeName||string||
|&emsp;&emsp;&emsp;&emsp;policyName||string||
...
**接口地址**:`/api/device/{id}/deviceReport`
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|Result«DeviceReportResultDTO»|
|201|Created||
|401|Unauthorized||
|403|Forbidden||
|404|Not Found||
...
| -------- | -------- | ----- |----- | 
|code||integer(int32)|integer(int32)|
|data||DeviceReportResultDTO|DeviceReportResultDTO|
|&emsp;&emsp;deviceReports||array|DeviceReportVO|
|&emsp;&emsp;&emsp;&emsp;energyConsumption||number||
|&emsp;&emsp;&emsp;&emsp;modeName||string||
|&emsp;&emsp;&emsp;&emsp;policyName||string||
|&emsp;&emsp;&emsp;&emsp;power||number||
|&emsp;&emsp;&emsp;&emsp;status||integer||
|&emsp;&emsp;&emsp;&emsp;timestamp||string||
|&emsp;&emsp;total||integer(int64)||
|&emsp;&emsp;totalEnergyConsumption||number(float)||
|message||string||
